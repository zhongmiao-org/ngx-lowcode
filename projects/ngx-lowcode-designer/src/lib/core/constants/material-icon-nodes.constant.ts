export type NgxLowcodeIconNodeTag = 'path' | 'line' | 'polyline' | 'polygon' | 'rect' | 'circle' | 'ellipse';
...
export function resolveLowcodeMaterialIconNodes(key: NgxLowcodeMaterialIconKey): readonly NgxLowcodeIconNode[] {
